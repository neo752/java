				...
				.hover(
						function() {
							...
							if (settings.position == "right") {
								if (imageLeft + imageWidth + settings.offset
										+ settings.xzoom > screen.width) {
									leftpos = imageLeft - settings.offset
											- settings.xzoom
								} else {
								...
								leftpos = imageLeft - settings.xzoom
										- settings.offset;
								if (leftpos < 0) {
									leftpos = imageLeft + imageWidth
											+ settings.offset
							...
							$(document.body)
									.mousemove(
											function(e) {
												...
												scrolly = ypos;
												$("div.zoomdiv").get(0).scrollTop = scrolly
														* scaley;
												scrollx = xpos;
												$("div.zoomdiv").get(0).scrollLeft = (scrollx)
														* scalex
											})
						}, function() {
